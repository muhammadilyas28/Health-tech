...
let sideNavDiv = () => {
    return `<div id="sidebar" class="md:z-50 mt-16 md:mt-0 sidebar sidebar-closed w-64 bg-gray-800 text-white h-screen absolute md:relative z-10 md:-translate-x-52 md:hover:translate-x-0">
        ...
        <div class="block py-2.5 px-4 rounded transition duration-200 text-blue-500 font-bold text-xl">Admin Dashboard</div>
            ...
            <nav class="mt-6">
                <a href="../RoleManagement/user role.html" onclick="dashboardInj()" class="block py-2.5 px-4 rounded transition duration-200 hover:bg-gray-700">Role Management</a>
                <a href="#" class="block py-2.5 px-4 rounded transition duration-200 hover:bg-gray-700"></a>
...
let profileInj = () => {
    ...
    mainDiv.innerHTML = `
        ...
        ${ProfileManagement()}
    `;
    document.getElementById("backButton").addEventListener("click", dashboardInj);
};
